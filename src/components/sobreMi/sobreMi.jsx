...
const SobreMi = () => {
    ...
    const handleDownload = () => {
        ...
        link.href = '/Dev_10EdgarSteinberg6.pdf'; // Reemplaza con la ruta correcta de tu CV
        link.download = 'Dev_10EdgarSteinberg.pdf'; // Nombre del archivo que se descargará
        link.click();
    };
    useEffect(() => {
        fetch(url, {
