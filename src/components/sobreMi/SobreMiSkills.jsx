                ...
                <div className={styles.imagenes_Skills}>
                    {skills.frontend && skills.frontend.map((skill, index) => (
                        <div className={styles.divContainerTools} key={index} >
                            <img className={styles.img_skills} src={`http://localhost:8080/skills/frontend/${skill.image}`} alt={`skill ${index}`} />
            ...
            <div>
                ...
                <div className={styles.imagenes_Skills}>
                    {skills.backend && skills.backend.map((skill, index) => (
                        <div className={styles.divContainerTools} key={index} >
                            <img className={styles.img_skills} src={`http://localhost:8080/skills/backend/${skill.image}`} alt={`skill ${index}`} />
                            <p className={styles.p}>{skill.title}</p>
                        </div>
                    ))}
                </div>
            ...
            <div>
                ...
                <div className={styles.imagenes_Skills}>
                    {skills.tools && skills.tools.map((skill, index) => (
                        <div className={styles.divContainerTools} key={index} >
                            <img className={styles.img_skills} src={`http://localhost:8080/skills/tools/${skill.image}`} alt={`skill ${index}`} />
                            <p className={styles.p}>{skill.title}</p>
                        </div>
                    ))}
                </div>
